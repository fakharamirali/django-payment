...
__all__ = ['BaseRequestBackend']

User = get_user_model()
logger = logging.getLogger(__name__)


class BaseRequestBackend(BaseBackend):
    @classmethod
    ...
    def handle_create(self, response: Response):
        ...
        self.transaction_id = result[self.TRANSACTION_ID_KEY_NAME]
    ...
    def send_create_request(self, callback_uri, **kwargs) -> Response:
        ...
        order_suffix = self.portal.order_id_prefix or self.portal.code_name
        data = {
            self.API_KEY_NAME: str(self.api_key),
    ...
    def get_verify_context(self):
        return {
            ...
            self.TRANSACTION_ID_KEY_NAME: self.transaction_id
        }
