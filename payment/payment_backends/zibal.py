...
from payment.payment_backends import BaseRequestBackend


@register
class ZibalBackend(BaseRequestBackend):
    name = _('Zibal')
    ...
    TRANSLATE_DICTIONARY = BaseRequestBackend.TRANSLATE_DICTIONARY | {
        'phone': 'mobile',
